...
一般酒_総酸 <- signif(rnorm(1000 * 一般酒_比率, mean = 一般酒_総酸_平均, sd = 一般酒_総酸_標準偏差), 3)
一般酒_アミノ酸度 <- signif(rnorm(1000 * 一般酒_比率, mean = 一般酒_アミノ酸度_平均, sd = 一般酒_アミノ酸度_標準偏差), 3)
一般酒_甘辛度 <- signif(rnorm(1000 * 一般酒_比率, mean = 一般酒_甘辛度_平均, sd = 一般酒_甘辛度_標準偏差), 3)
...
吟醸酒_総酸 <- signif(rnorm(1000 * 吟醸酒_比率, mean = 吟醸酒_総酸_平均, sd = 吟醸酒_総酸_標準偏差), 3)
吟醸酒_アミノ酸度 <- signif(rnorm(1000 * 吟醸酒_比率, mean = 吟醸酒_アミノ酸度_平均, sd = 吟醸酒_アミノ酸度_標準偏差), 3)
吟醸酒_甘辛度 <- signif(rnorm(1000 * 吟醸酒_比率, mean = 吟醸酒_甘辛度_平均, sd = 吟醸酒_甘辛度_標準偏差), 3)
...
純米酒_総酸 <- signif(rnorm(1000 * 純米酒_比率, mean = 純米酒_総酸_平均, sd = 純米酒_総酸_標準偏差), 3)
純米酒_アミノ酸度 <- signif(rnorm(1000 * 純米酒_比率, mean = 純米酒_アミノ酸度_平均, sd = 純米酒_アミノ酸度_標準偏差), 3)
純米酒_甘辛度 <- signif(rnorm(1000 * 純米酒_比率, mean = 純米酒_甘辛度_平均, sd = 純米酒_甘辛度_標準偏差), 3)
...
本醸造酒_総酸 <- signif(rnorm(1000 * 本醸造酒_比率, mean = 本醸造酒_総酸_平均, sd = 本醸造酒_総酸_標準偏差), 3)
本醸造酒_アミノ酸度 <- signif(rnorm(1000 * 本醸造酒_比率, mean = 本醸造酒_アミノ酸度_平均, sd = 本醸造酒_アミノ酸度_標準偏差), 3)
本醸造酒_甘辛度 <- signif(rnorm(1000 * 本醸造酒_比率, mean = 本醸造酒_甘辛度_平均, sd = 本醸造酒_甘辛度_標準偏差), 3)
